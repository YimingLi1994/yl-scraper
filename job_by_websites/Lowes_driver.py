...
def do_the_job(jobdict, driver=None):
    workload = {'JOB': {'SKU': 'js(return window.digitalData.products[0].ivm;)',
                        'UPC': 'js(return document.evaluate("//div[contains(@class,\'pd-image-holder\')]//img[contains(@class,\'product-image\')]", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue.src;)',
                        'availability': [
                            'js(return window.digitalData.products[0].availability[\'truck\']["availabilityStatus"];)',
                            '//div[contains(@class, "pd-shipping-delivery")]/div[contains(@class,"fulfillment-method-body")]/div[contains(@class,"body")]/p',
                            '//*[@id="main"]//div[contains(@class,\'alert\') and contains(@class,\'alert-warning\')]'],
                        'brand': '//div[contains(@class, "pd-title")]//meta[contains(@itemprop,"brand")]/@content',
                        'channel': 'js(return window.digitalData.products[0].vendorNumber;)',
                        'meta': [
                            '//div[contains(@class,"pd-price")]//span[contains(@class,\'green\') and contains(@class,\'h5\')]',
                            '//*[@id="ecorebates"]'],
                        'model': '//div[contains(@class,"pd-left")]//div[contains(@class,"pd-numbers")]/p',
                        'page_path': '//div[contains(@class,"pd-breadcrumbs")]/ul[contains(@role,"navigation")]',
                        'price': ['js(return window.digitalData.products[0].sellingPrice;)',
                                  '//div[contains(@class,"pd-pricing")]//span[contains(@itemprop, "price")]/@content'],
                        'price_type': 'js(return window.digitalData.products[0].displayPriceType;)',
                        'product_title': '//div[contains(@class, "pd-title")]//meta[contains(@itemprop,"name")]/@content',
                        'rating': '//div[contains(@class,"pd-left")]//div[contains(@class,"reviews")]/a[contains(@title,"Reviews")]/@aria-label',
                        'reviews': '//div[contains(@class,"pd-left")]//div[contains(@class,"reviews")]/a[contains(@title,"Reviews")]',
                        'shipping': [
                            "//div[contains(@class,'pd-shipping-delivery')]//div[contains(@class,'fulfillment-method-head')]",
                            '//*[@id="main"]//div[contains(@class,\'alert\') and contains(@class,\'alert-warning\')]'],
                        'style': '//div[contains(@data-behavior, "menu")][1]',
                        'style2': '//div[contains(@data-behavior, "menu")][2]'},
                'PID': jobdict['PID'],
                'PRE_REQ': ['//div[contains(@class,"pd-breadcrumbs")]/ul[contains(@role,"navigation")]',
                            '//div[contains(@class,"pd-left")]//div[contains(@class,"pd-numbers")]/p',
                            '//div[contains(@class, "pd-shipping-delivery")]/div[contains(@class,"fulfillment-method-body")]/div[contains(@class,"body")]/p|//*[@id="main"]//div[contains(@class,\'alert\') and contains(@class,\'alert-warning\')]'],
                'STATUS': 'READY',
                'URL': 'http://www.lowes.com/pd/-/{}'.format(jobdict['PID']) if jobdict['URL'] is None else jobdict['URL'],
                'WEBSITE': 'Lowes'}
...
if __name__ == '__main__':
    payload_dict = {
        ...
        'PID': '1000245233',
        'SKU': '1000245233',
        'URL': '''https://www.lowes.com/pd/Frigidaire-25-5-cu-ft-Side-by-Side-Refrigerator-with-Ice-Maker-EasyCare-Stainless-Steel/1000245233''',
        'TAG': 'TEST'
    }
