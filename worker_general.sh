...
sudo -u yl-scraper git clone https://github.com/YimingLi1994/yl-scraper.git /home/yl-scraper/yl-scraper
sudo chmod +x /home/yl-scraper/yl-scraper/chromedriver_linux64/chromedriver
cd home/yl-scraper/yl-scraper
sudo -u yl-scraper python3 worker_job_index.py general_scraping 3 &> logfile.txt